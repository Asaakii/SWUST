...
void my_format()
{
    ...
    strcpy(blk0->information, "文件系统Ver1.1\n块大小=1KB 全大小=1000KB 块数目=1000 根块数=2\n");
    blk0->root = 5;
